...
var calendar = {
  ...
  gongLiJieRi: function (mon,day) {
    ...
    var str = 0;
    if(calendar.sFtv[mon + day]){
      str = calendar.sFtv[mon + day];
    }
    return str;
  },
  /**
  ...
  longLiJieRi: function (mon,day) {
    ...
    var str = 0;
    if(calendar.Ftv[mon + day]){
      str = calendar.Ftv[mon + day];
    }
    return str;
  },
  /**
  ...
  solar2lunar: function (y, m, d) { //参数区间1900.1.31~2100.12.31
    ...
    var gongLiJieRis = calendar.sFtv[m1 + d1] || '';

    var m2 = month.toString();
    var d2 = day.toString();
    if(m2.length == 1){
      m2 = "0" + m2
    }
    ...
    var longLiJieRis = calendar.Ftv[m1 + d1] || '';
    ...
    return {
      ...
      'Term': Term,
      'astro': astro,
      'gongLiJieRi': gongLiJieRis,
      'longLiJieRi': longLiJieRis
    }
  },
